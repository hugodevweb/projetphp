...
<div class="hero is-fullheight" style="background: url('./images/banner.jpg') center/cover no-repeat;">
  ...
  <form action="./modif_mdp_action.php" method="post">
    ...
    <label for="old-psw"><b>Ancien mot de passe</b></label>
    <input type="password" class="input" placeholder="Entrez Mot de passe" name="old-psw" id="psw" required>

    <label for="psw"><b>Nouveau mot de passe</b></label>
    <input type="password" class="input" placeholder="Entrez Mot de passe" name="newpsw1" id="psw" required>

    <label for="psw-repeat"><b>Confirmez mot de passe</b></label>
    <input type="password" class="input" placeholder="Repetez le mot de passe" name="newpsw2" id="newpsw2" required>
    <hr>

    <button type="submit" class="button is-success is-medium is-fullwidth">M'inscrire</button>
